...
public class firefox_TC002 {
	...
	public void AutomateSeelive() throws InterruptedException, IOException
	{
		...
		driver = se.firefoxbrowser(driver);
		WikipediaPage shp = new WikipediaPage(driver);
		driver.get(prop.getData("URL"));
		
		logger.log(LogStatus.PASS, "Able to open firefox Browser");
		
		
		
		//Implicit wait for page loading
	     driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	     se.isElementPresent(driver,shp.seelivebtn ,10);
